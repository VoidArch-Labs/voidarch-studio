// dfc:blocker - blocker state on the `blocker` table (schema 0004).
//   pnpm dfc:blocker add --text "CI fails on Node 20" [--task goal] [--session s1] [--tags a,b]
//   pnpm dfc:blocker list [--all] [--json]        (default: open only)
//   pnpm dfc:blocker resolve --id blocker:abc [--note "bumped Node to 22"]
...
function usage(msg: string): never {
  console.error(msg);
  console.error("usage: pnpm dfc:blocker <add|list|resolve|get|delete> [--text ...] [--id ...]");
  process.exit(2);
}
