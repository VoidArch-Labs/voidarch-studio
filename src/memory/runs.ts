...
// dfc:log-tool / dfc:log-run CLIs append to the local JSONL buffer under
// `.agent-runs/sessions/<id>/`; `dfc:import-runs` is the ONLY thing that reads
...
/** Read an optional explicit run.json summary (written by dfc:log-run). */
