...
final class ProfileStore: ObservableObject {
    ...
    private static var fileURL: URL {
        ...
        let preferred = home.appending(path: ".voidarch-studio/providers.json")
        // Legacy pre-rename location: read it if the new one doesn't exist yet.
        let legacy = home.appending(path: ".nox-studio/providers.json")
